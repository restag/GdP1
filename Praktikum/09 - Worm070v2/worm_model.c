...
//*********************************************************
//* setters
void setCurLastindex(worm_t* theWorm, int index)
{
    theWorm -> cur_lastindex = index;
}

void setWormInitialLength(worm_t* theWorm)
{
    theWorm -> cur_lastindex = WORM_INITIAL_LENGTH -1;
}
