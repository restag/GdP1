// Compare to program callocBasics1.c
// In this version we use calloc
#include<stdio.h>
#include<stdlib.h>
...
int main (void) {
  ...
  // Allocate memory again but this time using calloc
  // Allocate SIZE int objects on the heap and initialize
  sa = calloc( SIZE , sizeof(int) );
